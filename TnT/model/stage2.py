...
from monai.networks.nets import resnet50, vit#, resnet18
...
class TnTS2_ViT(nn.Module):
    def __init__(self, n_locs_v=21, n_locs_a=29, n_lats=2, img_size=64):
        super().__init__()
        self.n_locs_v, self.n_locs_a, self.n_lats = n_locs_v, n_locs_a, n_lats
        self.bb = vit.ViT(in_channels=3, img_size=(img_size,img_size,img_size), patch_size=(8,8,8), dropout_rate=0.1) # outputs [B, 768]

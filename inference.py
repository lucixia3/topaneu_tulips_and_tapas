...
if __name__ == '__main__':
    ...
    S1_path = None # '/home/tue20260926/Models/TopAneu-26/Stage1/nnUNetTrainer_single_encoder_mixed__nnUNetPlans__3d_fullres'
    S2_path = '/home/tue20260926/Repos/topaneu_tulips_and_tapas/_tune/TnTS2_training_from-10:17:54-17.08.26/best_val_loss'
    ...
    res, agg, avg = ev.eval_ds(test)#(test.src, test.cases)
    ...
    os.makedirs('results_with_s1', exist_ok=True)
    ev.plot(agg, 'results_with_s1/per_class_heatmap.png')
    ev.re_eval_by_modality(res, 'results_with_s1')
    with open('results_with_s1/per_cls.json', 'w') as f:
